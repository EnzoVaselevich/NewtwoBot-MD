...
do {
let lineM = '━━━━━━━━━━━━━━━━━━━━'
opcion = await question(`SELECCIONE UN SOLO METODO\n${lineM}\n1 Codigo QR\n2 Codigo de 8 digitos\n\n${chalk.bold.cyanBright('---> ')}`)
...
console.log(chalk.bgBlack(chalk.bold.redBright("Comience con el código de país de su número de WhatsApp, ejemplo: +54878877382\n")))
process.exit(0)
}} else {
while (true) {
numeroTelefono = await question(chalk.bgBlack(chalk.bold.yellowBright('Ingresa el número que sera bot\nPor ejemplo: +54837727373\n')))
numeroTelefono = numeroTelefono.replace(/[^0-9]/g, '')

if (numeroTelefono.match(/^\d+$/) && Object.keys(PHONENUMBER_MCC).some(v => numeroTelefono.startsWith(v))) {
break 
} else {
console.log(chalk.bgBlack(chalk.bold.redBright("Por favor, escriba su número de WhatsApp.\nEjemplo: +5419992095479.\n")))
}}
rl.close()  
} 
...
unlinkSync(`./NaufraBotSession/${files}`)
})
} 
...
global.reloadHandler = async function(restatConn) {
 ...
 conn.welcome = '╭───────────────────•⊹⋆\n╎ @subject\n╰───────────────────•⊹⋆\n\n╭────────────•⊹⋆\n╎👤 @user\n╰────────────•⊹⋆\n                      ╭────────────•⊹⋆\n                      ╎👋🏻 \`BIENVENIDO/A\`\n                     ╰────────────•⊹⋆\n╭────────────•⊹⋆\n╎ \`LEA LAS REGLAS\` 📋\n╰────────────•⊹⋆\n@desc\n> NewtwoBot-MD';
    conn.bye = '╭────────────•⊹⋆\n╎👤 @user\n╰────────────•⊹⋆\n                      ╭────────────•⊹⋆\n                      ╎👋🏻 `ADIOS SEÑOR/A`\n                      ╰────────────•⊹⋆\n╭────────────•⊹⋆\n╎ `DICEN QUE AMA A`\n╎ `KUNNO` 🐍\n╰────────────•⊹⋆\n\n> NewtwoBot-MD';
  conn.spromote = '╭──────────────────•⊹⋆\n╎       💭 \`INFORMACION\` 💭\n╰──────────────────•⊹⋆\n\n『✦』𝙀𝙡 𝙥𝙖𝙧𝙩𝙞𝙘𝙞𝙥𝙖𝙣𝙩𝙚: @user\n𝙛𝙪𝙚 𝙖𝙨𝙞𝙜𝙣𝙖𝙙𝙤 𝙘𝙤𝙢𝙤 𝙖𝙙𝙢𝙞𝙣 𝙚𝙣 𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤.';
  conn.sdemote = '╭──────────────────•⊹⋆\n╎       💭 \`INFORMACION\` 💭\n╰──────────────────•⊹⋆\n\n『✦』𝙀𝙡 𝙥𝙖𝙧𝙩𝙞𝙘𝙞𝙥𝙖𝙣𝙩𝙚: @user\n𝙛𝙪𝙚 𝙙𝙚𝙨𝙘𝙖𝙧𝙩𝙖𝙙𝙤 𝙘𝙤𝙢𝙤 𝙖𝙙𝙢𝙞𝙣 𝙚𝙣 𝙚𝙨𝙩𝙚 𝙜𝙧𝙪𝙥𝙤.';
  conn.sDesc = '╭──────────────────•⊹⋆\n╎       💭 \`INFORMACION\` 💭\n╰──────────────────•⊹⋆\n\n『✦』𝙎𝙚 𝙝𝙖 𝙘𝙤𝙣𝙛𝙞𝙜𝙪𝙧𝙖𝙙𝙤 𝙡𝙖 𝙙𝙚𝙨𝙘𝙧𝙞𝙥𝙘𝙞𝙤𝙣 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤:\n\n@desc';
  conn.sSubject = '╭──────────────────•⊹⋆\n╎       💭 \`INFORMACION\` 💭\n╰──────────────────•⊹⋆\n\n『✦』𝙎𝙚 𝙝𝙖 𝙘𝙤𝙣𝙛𝙞𝙜𝙪𝙧𝙖𝙙𝙤 𝙚𝙡 𝙣𝙤𝙢𝙗𝙧𝙚 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤:\n\n@subject';
  conn.sIcon = '╭──────────────────•⊹⋆\n╎       💭 \`INFORMACION\` 💭\n╰──────────────────•⊹⋆\n\n『✦』𝙎𝙚 𝙝𝙖 𝙘𝙤𝙣𝙛𝙞𝙜𝙪𝙧𝙖𝙙𝙤 𝙚𝙡 𝙥𝙚𝙧𝙛𝙞𝙡 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤.';
  conn.sRevoke = '╭──────────────────•⊹⋆\n╎       💭 \`INFORMACION\` 💭\n╰──────────────────•⊹⋆\n\n『✦』𝙎𝙚 𝙝𝙖 𝙗𝙤𝙧𝙧𝙖𝙙𝙤 𝙚𝙡 𝙚𝙣𝙡𝙖𝙘𝙚 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤 𝙖 𝙚𝙨𝙩𝙚 𝙚𝙣𝙡𝙖𝙘𝙚:\n\n@revoke';
